...
export default function LaboratoryPreview({ data, onClose, onDownload }: LaboratoryPreviewProps) {
  ...
  const documentDirection: 'ltr' = 'ltr';
  const sectionTitleFontSize = '14px';
  const sectionBodyFontSize = '12px';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-8">
            ...
            >
              <div style={{ position: 'relative', minHeight: '100%', paddingBottom: '32px' }}>
                <div style={{
                  position: 'absolute',
                  top: 0,
                  width: '80px',
                ...
                >
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      ...
                      <img
                        src={UNIVERSITY_LOGO}
                        alt="Universit? Abdelhamid Ibn Badis"
                  ...
                  <div style={{
                    ...
                    <div style={{ fontSize: sectionBodyFontSize }}>
                      {data.equipes && data.equipes.length > 0 ? (
                        ...
                        <div style={{ color: '#6B7280', fontSize: sectionBodyFontSize }}>
